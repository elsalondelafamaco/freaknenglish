...
const DICTS: Record<Lang, Dict> = {
  es: {
    ...
    "nav.storage": "Storage",
    "nav.carts": "Carritos",
    "nav.scheduleHealth": "Salud del horario",
    "nav.cleanup": "Cleanup",
    "nav.material": "Material extra",
    "nav.resources": "Material extra",
    "nav.mymaterial": "Mi material",
  ...
  en: {
    ...
    "nav.storage": "Storage",
    "nav.carts": "Carts",
    "nav.scheduleHealth": "Schedule health",
    "nav.cleanup": "Cleanup",
    "nav.material": "Extra material",
    "nav.resources": "Extra material",
    "nav.mymaterial": "My material",
