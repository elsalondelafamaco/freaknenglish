...
export class AdminController {
  ...
  createResource(
    ...
    @Body() body: { title: string; description?: string | null; objective?: string | null; category?: string | null; level?: 'beginner' | 'intermediate' | 'advanced' | null; contentHtml: string; position?: number; published?: boolean },
  ) {
